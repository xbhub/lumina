(function (factory) {
    ...
    if (typeof window.define === 'function') {
        ...
        }).define(['upload', 'jquery'], function(exports) { //layui加载
            var wangEditor = factory(layui.jquery)
...
_e(function (E, $) {
    ...
    // 百度地图的key
    E.config.mapAk = 'jukFbXjYCLn4MiaQu9l6ExH8CymnI1NZ';
            ...
            menu.clickEvent = function (e) {
                ...
                layui.upload.render({
                    url: '/api/upload',
                        ...
                        editor.command(e, 'insertHtml', _imgHtml);
                    }
                });
