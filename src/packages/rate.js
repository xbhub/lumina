...
layui.define('jquery', function (exports) {
    ...
    //字符常量
    MOD_NAME = 'rate',
    ELEM_VIEW = 'layui-rate',
    ICON_RATE = 'fa-rate',
    ICON_RATE_SOLID = 'fa-rate-solid',
    ICON_RATE_HALF = 'fa-rate-half',

    ICON_SOLID_HALF = 'fa-rate-solid fa-rate-half',
    ICON_SOLID_RATE = 'fa-rate-solid fa-rate',
    ICON_HALF_RATE = 'fa-rate fa-rate-half',
    ...
    Class.prototype.render = function () {
        ...
        for (var i = 1; i <= options.length; i++) {
            var item = '<li class="layui-inline"><i class="fa ' +
            ...
            if (options.half) {
                if (parseInt(options.value) !== options.value) {
                    if (i == Math.ceil(options.value)) {
                        temp = temp + '<li><i class="fa fa-rate-half" ' + style + '></i></li>';
                    } else {
                        temp = temp + item
                    }
                } else {
