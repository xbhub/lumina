layui.define(['admin', 'laytpl', 'laypage', 'form', 'dropdown'], function (exports) {
    "use strict";
    ...
    Class.prototype.renderToolbar = function () {
        ...
        if (options.canSearch) {
            var searchElem = '<div class="layui-table-tool-search"><form class="layui-form"><input type="text" name="wd" value="' + WD + '"><button lay-submit lay-filter="*" class="fa fa-search"></button></form></div>';
    ...
    Class.prototype.events = function () {
        ...
        that.layBody.on('click', '*[lay-event]', function () {
            ...
            if (options.autoShow && event == 'show') {
                $.ajax({
                    type: 'get',
                    url: options.autoShow.replace(':id', obj.data.id),
                    success: function (res) {
                        admin.popupRight({
